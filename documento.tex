...
\coorientador{Nome do seu Co-orientador}
...
\begin{document}	
	...
	%Elementos textuais
	\textual
	\input{elementos-textuais/1-introducao}
	\input{elementos-textuais/2-fundamentacao-teorica}
	\input{elementos-textuais/3-trabalhos-relacionados}
	\input{elementos-textuais/4-proposta}
	\input{elementos-textuais/5-avaliacao}
	\input{elementos-textuais/6-calendario-de-atividades}
	\input{elementos-textuais/7-conclusao}
	
	%Elementos pós-textuais	
	\bibliography{elementos-pos-textuais/referencias}
	\input{elementos-pos-textuais/referencias-manualmente}
	
	\imprimirglossario	
	\imprimirapendices
		% Adicione aqui os apendices do seu trabalho
		\input{elementos-pos-textuais/apendices/apendice-a}
	\imprimiranexos
